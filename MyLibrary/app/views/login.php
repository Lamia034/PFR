...
<body class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
  ...
  <!--login-->
  <form class="flex items-center justify-center h-screen" action="<?php echo BaseUrl ?>users/auth"  method="post">
    <!-- Login Container -->
    <div class="min-w-fit flex-col border bg-blue-100 bg-opacity-90 px-6 py-14 shadow-md rounded-[4px] " >

      <div class="mb-8 flex justify-center">
       <div class="text-2xl text-black "> Welcome back to your Library online!</div>
      </div>
      ...
      <button class="mt-5 w-full border p-2 bg-gradient-to-r from-blue-800 bg-blue-500 text-white rounded-[4px] hover:bg-slate-400 scale-105 duration-300" value="submit" name="submit" type="submit">Login</button>
      <div class="text-center text-sm text-grey-dark mt-4">
              <div class="text-grey-dark mt-6">
                You Don't have an account? 
                <a class="no-underline border-b border-blue text-blue" href="<?php echo BaseUrl; ?>home/register">
                    Register
                </a>.
            </div>
            </div>

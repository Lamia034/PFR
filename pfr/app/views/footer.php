...
<footer class="text-center bg-purple-600 text-white"> <!--bg-gray-900-->
  <div class="container px-6 pt-6">
    <div class="flex justify-center mb-6">
      ...
      <img class="hidden h-16 w-auto lg:block cursor-pointer " src="<?php echo BaseUrl;?>assets/img/logo.png" alt="Your Company">
    ...
    <div class="mb-6">
      <p>
        Our Lybrary welcoming you and your children .. let the enovation explode to the world !
      </p>
    </div>
    ...
    <div class="grid lg:grid-cols-4 md:grid-cols-2">
      ...
      <div class="mb-6">
        <h5 class="uppercase text-cyan-400 font-bold mb-2.5">About</h5>
      ...
      <div class="mb-6">
        <h5 class="uppercase text-cyan-400 font-bold mb-2.5">Localisation</h5>
      ...
      <div class="mb-6">
        <h5 class="uppercase text-cyan-400 font-bold mb-2.5">Adress</h5>
      ...
      <div class="mb-6">
        <h5 class="uppercase text-cyan-400 font-bold mb-2.5">Informations</h5>
